...
class UserAuthenticationApi : ApiClient() {
    ...
    suspend fun login(body: LoginRequest): TokenResponse {
     ...
     */
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun magicLinkLogin(body: MagicLinkLoginRequest): MagicLinkLoginResponse {
        val localVariableBody: Any = body
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
        val localVariableConfig = RequestConfig(
            method = RequestMethod.POST,
            path = "/auth/magic_link",
            query = localVariableQuery,
            headers = localVariableHeaders
        )
     ...
     */
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun refreshToken(body: RefreshRequest): TokenResponse {
        val localVariableBody: Any = body
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
        val localVariableConfig = RequestConfig(
     ...
     */
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun twoFactorAuthentication(body: Confirm2Fa): TokenResponse {
        val localVariableBody: Any = body
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
        val localVariableConfig = RequestConfig(
