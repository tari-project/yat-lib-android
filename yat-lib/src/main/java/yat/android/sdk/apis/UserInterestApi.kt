...
class UserInterestApi : ApiClient() {
    ...
    suspend fun deleteUserInterest(emojiId: String): UserInterest {
        val localVariableBody: Any? = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
        val localVariableConfig = RequestConfig(
            method = RequestMethod.DELETE,
            path = "/user_interests/{emoji_id}".replace("{" + "emoji_id" + "}", emojiId),
     ...
     */
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun getInterestedUsers(dir: String?, limit: Int?, page: Int?, sort: String?): ListOfUserInterest {
        val localVariableBody: Any? = null
     ...
     */
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun getUserInterestForYat(emojiId: String): UserInterest {
        val localVariableBody: Any? = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
        val localVariableConfig = RequestConfig(
     ...
     */
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun registerInterest(body: NewUserInterestParameters): UserInterest {
