...
class UsersApi : ApiClient() {
    ...
    /**
     * Disable chosen 2FA provider or disable completely using backup code and user primary ID
     *
     * @param body
    ...
    suspend fun backupDisable2FA(body: BackupDisableBody): SuccessResponse {
        val localVariableBody: Any = body
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
        val localVariableConfig = RequestConfig(
            method = RequestMethod.POST,
            path = "/account/2fa/backup_disable",
     ...
     */
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun confirm2FA(body: Confirm2FaUpdate): SuccessResponse {
        val localVariableBody: Any = body
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
        val localVariableConfig = RequestConfig(
            method = RequestMethod.POST,
            path = "/account/2fa/confirm",
            query = localVariableQuery,
            headers = localVariableHeaders
        )
        val localVarResponse = request<SuccessResponse>(
     ...
     */
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun createUser(body: RegisterUserParameters): TokenResponse {
        val localVariableBody: Any = body
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
        val localVariableConfig = RequestConfig(
     ...
     */
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun deleteUser(id: java.util.UUID): DisplayUser {
    ...
    /**
     * Disable chosen 2FA provider or disable completely
     *
     * @param body
     * @return SuccessResponse
     * @throws UnsupportedOperationException If the API returns an informational or redirection response
     ...
     */
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun disable2FA(body: Disable2FABody): SuccessResponse {
        val localVariableBody: Any = body
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
        val localVariableConfig = RequestConfig(
     ...
     */
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun enable2FA(body: Enable2FABody): Enable2FAResponse {
        val localVariableBody: Any = body
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
        val localVariableConfig = RequestConfig(
     ...
     */
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun getAllUsers(dir: String?, limit: Int?, page: Int?, sort: String?): ListOfDisplayUserExtended {
        val localVariableBody: Any? = null
     ...
     */
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun load(organizationId: java.util.UUID?, userId: java.util.UUID?): LoadUser {
        val localVariableBody: Any? = null
        val localVariableQuery: MultiValueMap = mutableMapOf<String, List<String>>()
            .apply {
     ...
     */
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun send2FASms(): SuccessResponse2FA {
        val localVariableBody: Any? = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
        val localVariableConfig = RequestConfig(
            method = RequestMethod.POST,
            path = "/account/2fa/sms_code",
            query = localVariableQuery,
            headers = localVariableHeaders
        )
     ...
     */
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun showUser(id: java.util.UUID): DisplayUserExtended {
        val localVariableBody: Any? = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
        val localVariableConfig = RequestConfig(
     ...
     */
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun updateAccount(body: UpdateUserParameters): UpdateAccountResponse {
        val localVariableBody: Any = body
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
        val localVariableConfig = RequestConfig(
     ...
     */
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun updateUserByAdmin(id: java.util.UUID, body: AdminUpdateUserParameters): DisplayUser {
        val localVariableBody: Any = body
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
        val localVariableConfig = RequestConfig(
