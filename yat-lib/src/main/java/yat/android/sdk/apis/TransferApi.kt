...
import yat.android.sdk.models.AcceptTransfer
import yat.android.sdk.models.DisplayTransferRequest
import yat.android.sdk.models.ListOfDisplayTransferRequest
import yat.android.sdk.models.TransferRequest
...
class TransferApi : ApiClient() {
    ...
    suspend fun deleteTransfer(transferId: java.util.UUID): DisplayTransferRequest {
        val localVariableBody: Any? = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
        val localVariableConfig = RequestConfig(
            method = RequestMethod.DELETE,
            path = "/transfers/{transfer_id}".replace("{" + "transfer_id" + "}", "$transferId"),
    ...
    suspend fun listFiltered(
        acceptedAfter: java.time.OffsetDateTime?,
        dir: String?,
        limit: Int?,
        page: Int?,
    ...
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun listIncoming(accepted: Boolean): List<DisplayTransferRequest> {
        val localVariableBody: Any? = null
        val localVariableQuery: MultiValueMap = mutableMapOf<String, List<String>>()
            .apply {
        ...
        val localVarResponse = request<List<DisplayTransferRequest>>(
            localVariableConfig,
            localVariableBody
        )

        return when (localVarResponse.responseType) {
            ResponseType.Success -> (localVarResponse as Success<*>).data as List<DisplayTransferRequest>
            ResponseType.Informational -> throw UnsupportedOperationException("Client does not support Informational responses.")
            ResponseType.Redirection -> throw UnsupportedOperationException("Client does not support Redirection responses.")
            ResponseType.ClientError -> {
                val localVarError = localVarResponse as ClientError<*>
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun receiverAcceptTransfer(transferId: java.util.UUID, body: AcceptTransfer): List<String> {
        val localVariableBody: Any = body
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
        val localVariableConfig = RequestConfig(
            method = RequestMethod.POST,
            path = "/transfers/{transfer_id}/receiver_accept".replace("{" + "transfer_id" + "}", "$transferId"),
            query = localVariableQuery,
            headers = localVariableHeaders
        )
     ...
     */
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun requestTransfer(body: TransferRequest): DisplayTransferRequest {
        val localVariableBody: Any = body
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
        val localVariableConfig = RequestConfig(
     ...
     */
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun resendCode(transferId: java.util.UUID): Any {
        val localVariableBody: Any? = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
        val localVariableConfig = RequestConfig(
            method = RequestMethod.POST,
            path = "/transfers/{transfer_id}/resend_code".replace("{" + "transfer_id" + "}", "$transferId"),
            query = localVariableQuery,
            headers = localVariableHeaders
        )
     ...
     */
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun senderAcceptTransfer(transferId: java.util.UUID, body: AcceptTransfer): DisplayTransferRequest {
        val localVariableBody: Any = body
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
        val localVariableConfig = RequestConfig(
            method = RequestMethod.POST,
            path = "/transfers/{transfer_id}/sender_accept".replace("{" + "transfer_id" + "}", "$transferId"),
            query = localVariableQuery,
            headers = localVariableHeaders
        )
        val localVarResponse = request<DisplayTransferRequest>(
