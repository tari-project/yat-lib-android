...
class UserFeatureApi : ApiClient() {
    ...
    suspend fun readFeatures(): List<DisplayFeature> {
        ...
        val localVarResponse = request<List<DisplayFeature>>(
            localVariableConfig,
            localVariableBody
        )

        return when (localVarResponse.responseType) {
            ResponseType.Success -> (localVarResponse as Success<*>).data as List<DisplayFeature>
