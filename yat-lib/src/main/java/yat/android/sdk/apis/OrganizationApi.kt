...
class OrganizationApi : ApiClient() {
    ...
    /**
     * Load organization branding parameters
     *
     * @param id
    ...
    suspend fun getBranding(id: String): OrganizationBranding {
        val localVariableBody: Any? = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
        val localVariableConfig = RequestConfig(
            method = RequestMethod.GET,
            path = "/organizations/{id}/branding".replace("{" + "id" + "}", id),
     ...
     */
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun setBranding(id: String, body: UpdateOrganizationBranding): OrganizationBranding {
