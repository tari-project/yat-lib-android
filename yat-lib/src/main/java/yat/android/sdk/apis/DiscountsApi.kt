...
class DiscountsApi : ApiClient() {
    ...
    suspend fun activateRandomYatCode(codeId: java.util.UUID, body: RandomYatActivateBody): DisplayOrder {
        val localVariableBody: Any = body
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
        val localVariableConfig = RequestConfig(
            method = RequestMethod.POST,
            path = "/codes/{code_id}/random_yat".replace("{" + "code_id" + "}", "$codeId"),
     ...
     */
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun addPubkeyForCode(codeId: java.util.UUID, pubkey: String): String {
        val localVariableBody: Any? = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
        val localVariableConfig = RequestConfig(
            method = RequestMethod.POST,
            path = "/codes/{code_id}/pubkeys/{pubkey}".replace("{" + "code_id" + "}", "$codeId").replace("{" + "pubkey" + "}", pubkey),
            query = localVariableQuery,
            headers = localVariableHeaders
        )
     ...
     */
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun revokePubkeyForCode(codeId: java.util.UUID, pubkey: String): String {
        val localVariableBody: Any? = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
        val localVariableConfig = RequestConfig(
