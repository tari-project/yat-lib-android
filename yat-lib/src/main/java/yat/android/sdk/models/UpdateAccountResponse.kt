...
data class UpdateAccountResponse (
    ...
    val features: kotlin.collections.List<CurrentUserFeatures>? = null,
    /* A list of fine-grained permissions the user may perform. */
    @field:Json(name = "global_scopes")
    val globalScopes: List<UpdateAccountResponse.GlobalScopes>? = null,
    /* The role this user has in each organisation. Organisations are currently not used, but are reserved for  future operations. */
    @field:Json(name = "organization_roles")
    val organizationRoles: kotlin.collections.Map<kotlin.String, kotlin.String>? = null,
    ...
    @field:Json(name = "organization_scopes")
    val organizationScopes: kotlin.collections.Map<kotlin.String, kotlin.collections.List<kotlin.String>>? = null,
    /* List of transfers pending acceptance on current user side */
    @field:Json(name = "pending_transfers")
    val pendingTransfers: kotlin.collections.List<kotlin.String>? = null,
    ...
    val role: UpdateAccountResponse.Role? = null,
    @field:Json(name = "token_response")
    val tokenResponse: UpdateAccountResponseTokenResponse? = null,
    @field:Json(name = "user")
    val user: CurrentUserUser? = null
) : Serializable {
    companion object {
