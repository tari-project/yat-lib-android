...
class YatLibOutcomingTransactionActivity : AppCompatActivity(), MediaPlayer.OnCompletionListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        showCircularRevealFromCenter(ui.yatLibRootReveal, true)
    }
    ...
    private fun showVideoByUrl(url: String) = with(ui) {
        ...
        try {
            MediaPlayer().apply {
                ...
                prepare()
                setOnCompletionListener(this@YatLibOutcomingTransactionActivity)
    ...
    override fun onCompletion(p0: MediaPlayer?) = showSent()
    ...
    companion object {
        ...
        fun start(context: Activity, outcomingTransactionData: YatLibOutcomingTransactionData) {
            val intent = Intent(context, YatLibOutcomingTransactionActivity::class.java)
